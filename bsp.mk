...
# This board has an MCU with 512K of internal flash, but also has an external
# QSPI flash. Enable storage of the wifi firmware (for applications which use wifi)
# in external flash to save space in internal flash for the application.
BSP_DEFINES:=CY_USING_HAL CY_ENABLE_XIP_PROGRAM CY_STORAGE_WIFI_DATA=\".cy_xip\"
...
MPN_LIST:=CY8C6245LQI-S3D72 LBEE5KL1DX
DEVICE:=CY8C6245LQI-S3D72
ADDITIONAL_DEVICES:=CYW4343WKUBG
DEVICE_COMPONENTS:=4343W CAT1 CAT1A HCI-UART MURATA-1DX PSOC6_03
DEVICE_CY8C6245LQI-S3D72_CORES:=CORE_NAME_CM0P_0 CORE_NAME_CM4_0
DEVICE_CY8C6245LQI-S3D72_DIE:=PSoC6A512K
DEVICE_CY8C6245LQI-S3D72_FEATURES:=CM4_0_FPU_PRESENT
DEVICE_CY8C6245LQI-S3D72_FLASH_KB:=512
DEVICE_CY8C6245LQI-S3D72_SRAM_KB:=256
DEVICE_CYW4343WKUBG_DIE:=4343A1
DEVICE_CYW4343WKUBG_FLASH_KB:=0
DEVICE_CYW4343WKUBG_SRAM_KB:=512
DEVICE_LIST:=CY8C6245LQI-S3D72 CYW4343WKUBG
